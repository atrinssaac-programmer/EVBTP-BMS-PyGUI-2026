...
class BMSWindow(QMainWindow):
    ...
    def build_ui(self):
        ...
        main.addWidget(self.build_title_with_logo())      # <-- replaces build_title()
    ...
    def build_title_with_logo(self):
        ...
        if logo_path.exists():
            ...
            # Scale logo to reasonable height (e.g. 64px) while keeping aspect ratio
    ...
    def build_diagnostics(self):
        ...
        # main_layout.addWidget(self.chartView)   # kept commented as in original
